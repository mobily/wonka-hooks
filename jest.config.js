module.exports = {
  ...
  moduleNameMapper: {
    ...
    '^@mobily/wonka-extras/src/WonkaExtras.bs.js$':
      '<rootDir>/node_modules/@mobily/wonka-extras/dist/index.js',
  },
  restoreMocks: true,
  transform: {
    '^.+\\.bs.js$': 'babel-jest',
  ...
  transformIgnorePatterns: [
    'node_modules/(?!(reason-test-framework|bs-platform|wonka|@mobily/wonka-extras)/.*)',
  ],
}
